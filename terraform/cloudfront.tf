# CloudFront distribution with dual origins (S3 for frontend, ALB for API)
...
resource "aws_cloudfront_distribution" "main" {
  ...
  # Default Cache Behavior (S3 origin for frontend)
  ...
  # Ordered Cache Behavior for /api/* (ALB origin)
